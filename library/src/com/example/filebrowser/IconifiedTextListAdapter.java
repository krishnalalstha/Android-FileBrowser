...
public class IconifiedTextListAdapter extends BaseAdapter {
	...
	public List<IconifiedText> mItems = new ArrayList<IconifiedText>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final IconifiedTextView btv;
		if (convertView == null) {
			btv = (IconifiedTextView) View.inflate(mContext,
					R.layout.file_browse_list_item, null);
		} else { // Reuse/Overwrite the View passed
			// We are assuming(!) that it is castable!
			btv = (IconifiedTextView) convertView;
		}
		btv.setImage(mItems.get(position),showCheckBox);
